...
const UserDashboard = () => {
  const documentos = [
    { id: 1, name: 'Deep Learning Applications.pdf', author: 'Ian Goodfellow', tematica: 'Machine Learning', fecha: '2024-03-15', size: '2.4 MB', estado: 'Procesado' },
    { id: 2, name: 'Neural Networks Theory.pdf', author: 'Yoshua Bengio', tematica: 'Redes Neuronales', fecha: '2024-03-14', size: '3.1 MB', estado: 'Procesado' },
    { id: 3, name: 'Natural Language Processing.pdf', author: 'Christopher Manning', tematica: 'NLP', fecha: '2024-03-13', size: '1.8 MB', estado: 'Procesando' },
  ];
        ...
        <main className="p-6 md:p-8 w-full max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-left">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold text-slate-800 mt-1">247</h3>
                <p className="text-green-500 text-[10px] font-bold mt-1">+12 este mes</p>
              </div>
          ...
          <section className="bg-white p-8 rounded-3xl border-2 border-dashed border-slate-200 mb-8 transition-all hover:border-blue-400 hover:bg-blue-50/10 group">
            ...
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2.5 rounded-xl text-xs font-bold shadow-lg shadow-blue-200 mt-6 transition-all active:scale-95">
                ...
                <tbody className="divide-y divide-slate-50">
                  {documentos.map((doc) => (
                    <tr key={doc.id} className="hover:bg-blue-50/20 group">
                      ...
                      <td className="px-6 py-4 text-slate-500 text-xs">{doc.author}</td>
